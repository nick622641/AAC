...
export const CALLOUT_PRODUCTS_REQUEST = 'CALLOUT_PRODUCTS_REQUEST'
export const CALLOUT_PRODUCTS_SUCCESS = 'CALLOUT_PRODUCTS_SUCCESS'
export const CALLOUT_PRODUCTS_FAIL = 'CALLOUT_PRODUCTS_FAIL'
...
export const RANDOM_PRODUCTS_DETAILS_REQUEST = 'RANDOM_PRODUCTS_DETAILS_REQUEST'
export const RANDOM_PRODUCTS_DETAILS_SUCCESS = 'RANDOM_PRODUCTS_DETAILS_SUCCESS'
export const RANDOM_PRODUCTS_DETAILS_FAIL = 'RANDOM_PRODUCTS_DETAILS_FAIL'

export const SINGLE_RANDOM_PRODUCT_REQUEST = 'SINGLE_RANDOM_PRODUCT_REQUEST'
export const SINGLE_RANDOM_PRODUCT_SUCCESS = 'SINGLE_RANDOM_PRODUCT_SUCCESS'
export const SINGLE_RANDOM_PRODUCT_FAIL = 'SINGLE_RANDOM_PRODUCT_FAIL'
...
export const NEW_PRODUCT_USER_REQUEST = 'NEW_PRODUCT_USER_REQUEST'
export const NEW_PRODUCT_USER_SUCCESS = 'NEW_PRODUCT_USER_SUCCESS'
export const NEW_PRODUCT_USER_RESET = 'NEW_PRODUCT_USER_RESET'
export const NEW_PRODUCT_USER_FAIL = 'NEW_PRODUCT_USER_FAIL'
